                            ...
                            void *rsp, uint16_t *rsp_len)
{
    ...
    if (avail->sink_contexts == BTP_PACS_CHARACTERISTIC_AVAILABLE_AUDIO_CONTEXTS) {
        ...
        cb_data.snk_ctxts = avail->sink_contexts;
        cb_data.src_ctxts = avail->source_contexts;
    }
...
{
    int rc;
    const struct pacs_set_supported_contexts_cmd *sup_ctxts = cmd;
...
static const struct btp_handler handlers[] = {
    ...
    },
    {
        ...
        .expect_len = sizeof(struct pacs_update_characteristic_cmd),
        .func = pacs_update_characteristic,
    },
    {
        .opcode = BTP_PACS_SET_AVAILABLE_CONTEXTS,
        .expect_len = sizeof(struct pacs_set_available_contexts_cmd),
        .func = pacs_set_available_contexts,
    },
    {
        .opcode = BTP_PACS_SET_SUPPORTED_CONTEXTS,
        .expect_len = sizeof(struct pacs_set_supported_contexts_cmd),
