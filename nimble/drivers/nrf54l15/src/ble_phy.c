...
ble_phy_rx_xcvr_setup(void)
{
    ...
    if (g_ble_phy_data.phy_privacy) {
        ...
        /* TODO: NRF_AAR->SCRATCHPTR = (uint32_t)&g_ble_phy_data.phy_aar_scratch; */
    ...
    /* TODO: NRF_RADIO->EVENTS_RSSIEND = 0; */
...
ble_phy_rx_end_isr(void)
{
    ...
    /* TODO: assert(NRF_RADIO->EVENTS_RSSIEND != 0); */
...
ble_phy_rx_start_isr(void)
{
    ...
    if (g_ble_phy_data.phy_privacy && (dptr[3] & 0x40)) {
        ...
        /* TODO: NRF_AAR->ADDRPTR = (uint32_t)(dptr + 3 + adva_offset); */
...
ble_phy_init(void)
{
    ...
    /* TODO: NRF_CCM->SHORTS = CCM_SHORTS_ENDKSGEN_CRYPT_Msk; */
    NRF_CCM->EVENTS_ERROR = 0;
...
{
    /* TODO: NRF_AAR->NIRK = (uint32_t)g_nrf_num_irks; */
