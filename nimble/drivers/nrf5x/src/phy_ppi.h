...
/*
 * MCU-specific PPI abstraction dispatcher.
 * Routes to the correct chip-specific phy_ppi.h based on MCU_TARGET.
 */

#ifndef H_PHY_PPI_DISPATCH_
#define H_PHY_PPI_DISPATCH_
