...
phy_ppi_cs_mode_enable(void)
{
    ...
    NRF_TIMER0->SUBSCRIBE_CAPTURE[5] = DPPI_CH_SUB(RADIO_EVENTS_ADDRESS);

    PPIB_RADIO_PERI_6(TIMER0_EVENTS_COMPARE_1, GPIOTE20_TASKS_SET_0);
}
...
phy_ppi_cs_mode_disable(void)
{
    ...
    NRF_TIMER0->SUBSCRIBE_CAPTURE[5] = DPPI_CH_UNSUB(RADIO_EVENTS_ADDRESS);
    ...
    NRF_PPIB11->SUBSCRIBE_SEND[6] = DPPI_CH_UNSUB(TIMER0_EVENTS_COMPARE_1);
    NRF_PPIB21->PUBLISH_RECEIVE[6] = DPPI_CH_UNSUB(GPIOTE20_TASKS_SET_0);
}
#endif
