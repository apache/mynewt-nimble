...
phy_debug_init(void)
{
    ...
    PPIB_RADIO_PERI_4(TIMER0_EVENTS_COMPARE_4, GPIOTE20_TASKS_SET_0);
...
//    PPIB_RADIO_PERI_8(RADIO_EVENTS_STOP, GPIOTE20_TASKS_CLR_1);
    ...
    PPIB_RADIO_PERI_6(RADIO_EVENTS_RXREADY, GPIOTE20_TASKS_SET_2);
//    PPIB_MCU_PERI_0(DPPIC00_TIMER00_EVENTS_COMPARE_0, GPIOTE20_TASKS_SET_2);
    NRF_GPIOTE20->SUBSCRIBE_SET[PHY_GPIOTE_DEBUG_3] = DPPI_CH_SUB(GPIOTE20_TASKS_SET_2);

    PPIB_RADIO_PERI_7(RADIO_EVENTS_DISABLED, GPIOTE20_TASKS_CLR_2);
...
phy_ppi_init(void)
{
    ...
    NRF_RADIO->PUBLISH_RXREADY = DPPI_CH_PUB(RADIO_EVENTS_RXREADY);
    ...
    NRF_DPPIC10->CHENSET = DPPIC_CHEN_CH6_Msk | DPPIC_CHEN_CH11_Msk |
            DPPIC_CHEN_CH12_Msk | DPPIC_CHEN_CH13_Msk;
}
