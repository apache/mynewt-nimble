...
#define BLE_CS_EVENT_CS_SUBEVENT_DATA      (1)

#define BLE_CS_EVENT_CS_PROCEDURE_ERR_SUCCESS        (0)
#define BLE_CS_EVENT_CS_PROCEDURE_ERR_SETUP_FAILED   (1)
#define BLE_CS_EVENT_CS_PROCEDURE_ERR_ABORTED        (2)

#define BLE_HS_CS_TOA_TOD_NOT_AVAILABLE (0x00008000)
#define BLE_HS_CS_N_AP_MAX              (4)

#define BLE_HS_CS_SUBEVENT_COUNT_MAX 10
#define BLE_HS_CS_MODE0_RESULTS_COUNT_MAX 3
#define BLE_HS_CS_MODE1_RESULTS_COUNT_MAX 10
#define BLE_HS_CS_MODE2_RESULTS_COUNT_MAX 80
#define BLE_HS_CS_MODE3_RESULTS_COUNT_MAX 10

#define BLE_HOST_CS_CSA_TYPE_3B (0)
#define BLE_HOST_CS_CSA_TYPE_3C (1)
#define BLE_HOST_CS_CH3C_SHAPE_HAT (0)
#define BLE_HOST_CS_CH3C_SHAPE_X   (1)
...
struct ble_cs_subevent_info {
    struct ble_cs_mode0_result mode0_results[BLE_HS_CS_MODE0_RESULTS_COUNT_MAX];
    struct ble_cs_mode1_result mode1_results[BLE_HS_CS_MODE1_RESULTS_COUNT_MAX];
    struct ble_cs_mode2_result mode2_results[BLE_HS_CS_MODE2_RESULTS_COUNT_MAX];
    struct ble_cs_mode3_result mode3_results[BLE_HS_CS_MODE3_RESULTS_COUNT_MAX];
    uint8_t mode0_results_count;
    uint8_t mode1_results_count;
    uint8_t mode2_results_count;
    uint8_t mode3_results_count;
...
struct ble_cs_event {
    ...
    union {
        ...
        struct {
            uint8_t status;
            struct ble_cs_subevent_info *local_subevent_info;
