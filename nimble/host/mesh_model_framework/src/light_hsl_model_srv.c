...
static void lightness_state_change_cb (struct bt_mesh_model *model)
{
...
static void hue_state_change_cb (struct bt_mesh_model *model)
{
    if (model && model->user_data)
    {
...
static void sat_state_change_cb (struct bt_mesh_model *model)
{
    if (model && model->user_data)
    {
