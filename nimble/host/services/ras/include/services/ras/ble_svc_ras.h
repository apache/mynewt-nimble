...
typedef void ble_svc_ras_clt_ranging_header_received_cb(
        struct ble_svc_ras_clt_ranging_header *ranging_header, uint16_t conn_handle);
typedef void ble_svc_ras_clt_subevent_header_received_cb(
        struct ble_svc_ras_clt_subevent_header *sub_header, uint16_t conn_handle);
typedef void ble_svc_ras_clt_step_data_received_cb(void *data, uint16_t conn_handle,
                                                   uint8_t step_mode);
typedef void ble_svc_ras_clt_ranging_data_complete_cb(uint16_t conn_handle);
