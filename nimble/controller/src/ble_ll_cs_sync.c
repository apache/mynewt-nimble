...
void
ble_ll_cs_sync_tx_end(struct ble_phy_cs_sync_results *results)
{
    ...
    end_anchor_usecs = ble_ll_tmr_t2u(results->cputime) + results->rem_us;
...
void
ble_ll_cs_sync_rx_end(struct ble_phy_cs_sync_results *results)
{
    struct ble_ll_cs_sm *cssm = g_ble_ll_cs_sm_current;
    struct ble_phy_cs_transmission *transm;
    uint32_t end_anchor_usecs;
