...
ble_ll_cs_update_rem_capabilities(struct ble_ll_conn_sm *connsm, uint8_t *dptr)
{
    ...
    cap->t_sw = dptr[15];
    cap->t_ip1_capability = get_le16(dptr + 16) & 0x00FF;
    cap->t_ip2_capability = get_le16(dptr + 18) & 0x00FF;
    cap->t_fcs_capability = get_le16(dptr + 20) & 0x03FF;
    cap->t_pm_capability = get_le16(dptr + 22) & 0x07;
