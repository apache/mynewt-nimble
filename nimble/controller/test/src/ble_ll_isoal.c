...
static void
test_ial_broadcast_single_sdu_bis(
        const struct test_ial_broadcast_single_sdu_bis_cfg *cfg)
{
    ...
    _Static_assert(Max_SDU <= sizeof(os_mbuf_test_data),
                   "incorrect sdu length");

    ble_ll_isoal_mux_init(&mux, cfg->Max_PDU, cfg->ISO_Interval,
...
static void
test_ial_broadcast_large_sdu_bis(
        const struct test_ial_broadcast_large_sdu_bis_cfg *cfg)
{
    ...
    ble_ll_isoal_mux_init(&mux, Max_PDU, cfg->ISO_Interval,
                          cfg->SDU_Interval, cfg->BN, 0, cfg->Framed,
                          cfg->Framing_Mode);
...
static void
test_ial_broadcast_zero_length_sdu_bis(
        const struct test_ial_broadcast_zero_length_sdu_bis_cfg *cfg)
{
    ...
    ble_ll_isoal_mux_init(&mux, Max_PDU, ISO_Interval, SDU_Interval,
        ...
        const struct test_ial_unframed_empty_pdus_with_llid_0b01_cfg *cfg)
{
    ...
    TEST_ASSERT(cfg->mx_sdu <= sizeof(os_mbuf_test_data),
                "incorrect sdu length");
