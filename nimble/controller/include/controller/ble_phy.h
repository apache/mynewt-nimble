...
#define BLE_PHY_TRANSITION_TO_RX    (1)
#define BLE_PHY_TRANSITION_TO_TX    (2)
#define BLE_PHY_TRANSITION_TO_RX_ISO_SUBEVENT (3)
#define BLE_PHY_TRANSITION_TO_TX_ISO_SUBEVENT (4)
