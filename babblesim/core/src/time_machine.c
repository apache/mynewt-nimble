...
bs_time_t tm_get_hw_time_from_abs_time(bs_time_t abstime) //duplicate of tm_abs_time_to_hw_time?
{
...
tm_start(void)
{
    pthread_create(&tm_thread, NULL, tm_thread_fun, NULL);
}
